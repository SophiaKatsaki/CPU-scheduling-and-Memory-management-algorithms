...
public class NextFit extends MemoryAllocationAlgorithm
{
    ...
    */
    ...
    public int fitProcess(Process p, ArrayList<MemorySlot> currentlyUsedMemorySlots)
    {
       ...
       slots in the memory slots,and changes its value if the process does fit a slot. The
       address then,is set to the start address of the certain available slot.
       */
